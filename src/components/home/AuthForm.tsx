...
export default function AuthForm() {
    ...
    const handleGuestLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setLoading(false); // Only set loading false on error, otherwise we want to show loading until redirect/reload
            ...
            <Tabs defaultValue="login" className="w-full">
                ...
                <TabsContent value="guest" className="space-y-4 py-4">
                    ...
                    <form onSubmit={handleGuestLogin} className="space-y-4">
                        ...
                        <Button type="submit" variant="secondary" className="w-full" disabled={loading || !guestUsername.trim()}>
